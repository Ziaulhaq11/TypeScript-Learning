abstract class Department { //By implementing this abstract. Instances should call this method. Everything is same just add this to include abstract method
  ...
  static createEmployee(name: string) { //These static methods can accessed without instancing like Math.floor()
    return {name : name}
  }
}
...
class AccountingDepartment extends Department {
  ...
  private constructor(id: string, private reports: string[]) { //By adding private we're creating 'SingleTon & Private constructor' So that we wont use Multiple instances of this class
    super(id, 'Accounting')
